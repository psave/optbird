...
function graph2(response) {
  ...
  var building = $("#graph2_building_choice").val();
  var rmID = $("#graph2_room_choice").val();
  ...
  function setBuilding(building){
    ...
    $.get( "/charts/rooms.json?id="+building, function( data ) {
      ...
      $("#graph2_room_choice").html(which_rooms);
  ...
  $("#graph2_building_choice" ).change(function() {
    setBuilding($(this).val());
  });
  $("#graph2_room_choice" ).change(function() {
    reloadGraph();
  });
