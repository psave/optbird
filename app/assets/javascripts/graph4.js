function graph4(response_occupancy, response_courses) {
  ...
  $('.num_percent_choice4').change(function () {
    reloadGraph4();
  });

function reloadGraph4() {

  if (num_percent_choice.val() == "Number") {
    barChart();
    numberDataToChart4();
  }
  else if (num_percent_choice.val() == "Percent") {
    percentBarChart();
    percentDataToChart4();
  }
}
