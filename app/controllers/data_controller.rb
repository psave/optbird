class DataController < ApplicationController
  ...
  def show
    ...
    @courses_data = ActiveRecord::Base.connection.execute("SELECT room_id, daysmet, start_time, end_time, start_date, end_date, sec_enr_tot, capacity, short_title FROM courses")
