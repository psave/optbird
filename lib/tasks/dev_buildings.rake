...
namespace :csv do
  ...
  task :devbuildings => :environment do
    ...
    csv_file_path = 'db/confidential/ANGU-023_Second.csv'
    ...
    DevBuildings.populate_buildings(buildings)
    DevBuildings.populate_rooms()
    DevBuildings.populate_occupants(buildings)
    DevBuildings.populate_courses_room_id()
